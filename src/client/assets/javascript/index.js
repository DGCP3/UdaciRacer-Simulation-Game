...
let store = {
  ...
  async function handleCreateRace() {
	// render starting UI
	if (!store.player_id || !store.track_id) return;
	try {
	...
	return new Promise((resolve) => {
	  ...
	  */
	  try {
		...
		console.log("runRace", error.message);
	  }
	  /* 
